...
// you can find more protocol samples at the github page
// https://github.com/o-micron/BioCoderEditor/tree/master/Sample_protocols
// You can copy paste code from any sample and replace this main.cpp with it
// Have fun,
...
main()
{
  ...
  Fluid db_buffer =
    new_fluid("DB homogenization buffer",
              "0.4 M ammonium thiocyanate, 0.8 M guanidine thiocyanate, 38% "
              "v/v phenol, 0.1 M sodium acetate(pH 5.5), 5% v/v glycerol");
  ...
  Fluid scp =
    new_fluid("SCP solution", "1.2 M sodium chloride, 0.8M sodium citrate");
  ...
  Container sterile_microfuge_tube =
    new_container(STERILE_MICROFUGE_TUBE, tissue1);
  ...
  invert(plg);
  comment(
    "Do not vortex to prevent phase lock gel from breaking into small pieces");
