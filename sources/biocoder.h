...
\par Output:
\htmlonly Perform 0.8% agarose gel electrophoresis of (array1[0].contents.name) and (array1[1].contents.name)(5�l sample and 1�l of loading buffer), mixed with ethidium bromide
and visualize with UV transilluminator to confirm the presence of required product. \endhtmlonly
\sa nanodrop()
*/
