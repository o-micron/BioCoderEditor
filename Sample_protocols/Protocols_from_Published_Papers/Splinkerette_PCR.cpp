...
main()
{
  ...
  Container sterile_microfuge_tube1 =
    new_container(STERILE_MICROFUGE_TUBE, adaptor_mix);
  ...
  next_step("Digestion of tumor genomic DNA with restriction enzyme");
  {
    ...
    char*(initial_conc)[5] = {
      "--", "20 U �l<sup>-1</sup>", "10X", "10 mg ml<sup>-1</sup>", "--"
    };
    char*(final_conc)[5] = {
      "2 �g", "40 U", "1X", "0.33 �g �l<sup>-1</sup>", "--"
    };
    Volume* volumes[5] = {
      vol(1, UL), vol(2, UL), vol(3, UL), vol(1, UL), vol(23, UL)
    };
    mixing_table_pcr(6,
                     vol(30, UL),
                     fluid_array,
  ...
  next_step();
  {
    Fluid fluid_array[5] = { sterile_microfuge_tube.contents,
                             rxn_tube.contents,
                             ligase,
                             ligase_buff,
                             water };
    char*(initial_conc)[5] = {
      "2 �g in 30 �l", "25 �M", "20 U �l<sup>-1</sup>", "10X", "--"
    };
    char*(final_conc)[5] = { "300 ng", "25 pmol", "20 U", "1X", "--" };
    Volume* volumes[5] = {
      vol(4.5, UL), vol(1, UL), vol(1, UL), vol(4, UL), vol(29.5, UL)
    };
    mixing_table_pcr(6,
                     vol(40, UL),
                     fluid_array,
  ...
  next_step("Digestion to remove genomic DNA fragments with splinkerette "
            "adaptor ligated on both ends");
  {
    Fluid fluid_array[5] = {
      sterile_microfuge_tube2.contents, neb3, ecorv, bsa, water
    };
    char*(initial_conc)[5] = {
      "--", "10X", "20 U �l<sup>-1</sup>", "10 mg ml<sup>-1</sup>", "--"
    };
    char*(
      final_conc)[5] = { "--", "1X", "20 U", "0.1 �g �l<sup>-1</sup>", "--" };
    Volume* volumes[5] = {
      vol(40, UL), vol(10, UL), vol(1, UL), vol(1, UL), vol(48, UL)
    };
    mixing_table_pcr(6,
                     vol(100, UL),
                     fluid_array,
  ...
  next_step("Clean up the EcoRV digestion reaction using the QIAquick Gel "
            "Extraction Kit (not shown)");
  name_sample(sterile_microfuge_tube3,
              "Purified splinkerette adaptor ligated genomic DNA");
  ...
  {
    Fluid fluid_array[7] = { sterile_microfuge_tube3.contents,
                             primer1,
                             primer2,
                             dntp,
                             pfu_buff,
    ...
    char*(initial_conc)[7] = { "--",
                               ...
                               "2.5 U �l<sup>-1</sup>",
                               "--" };
    char*(final_conc)[7] = { "--", "0.1 �g", "0.1 �g", "0.25 mM",
                             "1X", "1.25 U", "--" };
    Volume* volumes[7] = { vol(5, UL), vol(1, UL),   vol(1, UL), vol(0.5, UL),
                           vol(5, UL), vol(0.5, UL), vol(37, UL) };
    mixing_table_pcr(8,
                     vol(50, UL),
                     fluid_array,
                     initial_conc,
  ...
  thermocycler(sterile_microfuge_tube4,
               29,
               94,
               time(15, SECS),
               68,
               ...
               NORMAL);
  pcr_final_ext(
    sterile_microfuge_tube4, 72, time(5, MINS), 4, time(15, MINS), 4);
  name_sample(sterile_microfuge_tube4, "Primary PCR product");

  next_step("Secondary PCR amplification");
  {
    Fluid fluid_array[5] = {
      sterile_microfuge_tube4.contents, primer1, primer2, mastermix, water
    };
    char*(initial_conc)[5] = {
      "--", "0.1 �g �l<sup>-1</sup>", "0.1 �g �l<sup>-1</sup>", "--", "--"
    };
    char*(final_conc)[5] = { "--", "0.1 �g", "0.1 �g", "--", "--" };
    Volume* volumes[5] = {
      vol(1, UL), vol(1, UL), vol(1, UL), vol(25, UL), vol(22, UL)
    };
    mixing_table_pcr(6,
                     vol(50, UL),
                     fluid_array,
                     ...
                     final_conc,
                     volumes,
                     sterile_microfuge_tube5);
  }

  next_step();
  pcr_init_denat(sterile_microfuge_tube5, 94, time(15, MINS));
  thermocycler(sterile_microfuge_tube5,
               25,
               94,
               time(15, SECS),
               60,
               ...
               NORMAL);
  pcr_final_ext(
    sterile_microfuge_tube5, 72, time(5, MINS), 4, time(15, MINS), 4);

  next_step("Agarose-gel analysis of splinkerette-PCR reactions");
  name_sample(sterile_microfuge_tube5,
              "results of the secondary splinkerette-PCR reaction");
