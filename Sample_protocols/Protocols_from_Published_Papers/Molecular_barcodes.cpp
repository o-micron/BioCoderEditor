...
main()
{
  ...
  {
    Fluid fluid_array[5] = {
      dig_rxn_buffer, dna, rest_enzyme1, rest_enzyme2, sdw
    };
    Volume* volumes[5] = {
      vol(2, UL), vol(1, UL), vol(0.5, UL), vol(0.5, UL), vol(16, UL)
    };
  ...
  {
    Fluid fluid_array[5] = {
      rxn_tube.contents, lig_buffer, t4ligase, hairpin, sdw
    };
    char* tubes[1] = { "Ligation" };
    Volume* volumes[5] = {
      vol(3, UL), vol(2, UL), vol(1, UL), vol(6, UL), vol(8, UL)
    };
  ...
  next_step("Thermal denaturation:");
  {
    ...
    Volume* volumes[5] = {
      vol(14, UL), vol(6, UL), vol(5.1, UL), vol(0.03, UL), vol(4.87, UL)
    };
  ...
  {
    Fluid fluid_array[10] = {
      rxn_buffer,         datp, dgtp, dttp, dctp, f_primer, r_primer,
      rxn_tube3.contents, taq,  sdw
    };
    char*(initial_conc)[10] = { "10X",  "10 mM", "10 mM", "10 mM",      "10 mM",
                                "1 mM", "1 mM",  "X",     "5 units/�l", "--" };
    char*(final_conc)[10] = { "1X",     "200 �M",  "200 �M",
                              "200 �M", "200 �M",  "0.5 �M",
                              "0.5 �M", "1 ng/�l", "0.02 units/�l",
                              "--" };
    Volume* volumes[10] = { vol(1, UL),   vol(0.2, UL), vol(0.2, UL),
                            vol(0.2, UL), vol(0.2, UL), vol(0.5, UL),
                            vol(0.5, UL), vol(1, UL),   vol(0.04, UL),
                            vol(XVAL, UL) };
    mixing_table_pcr(11,
                     vol(10, UL),
                     fluid_array,
  ...
  // 38 cycles of denaturation at 95deg, 30s, annealing at 55deg, 30s, extension
  // at 72deg, 45s
  next_step("38 cycles of PCR:");
  thermocycler(rxn_tube4,
               38,
               95,
               time(30, SECS),
               58,
