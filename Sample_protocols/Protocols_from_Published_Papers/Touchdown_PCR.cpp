...
main()
{
  ...
  first_step("PCR Step:");
  {
    Fluid fluid_array[8] = { pcr_buffer, mgcl2,    template_dna, dntp,
                             f_primer,   r_primer, dna_pol,      ddw };
    char*(initial_conc)[8] = { "10X",
                               "25 mM",
                               "--",
                               "2 mM",
                               "10 &#181M",
    ...
    char*(final_conc)[8] = { "1X",
                             ...
                             "--" };
    Volume* volumes[8] = {
      vol(5, UL), vol(3, UL), vol(10, UL),   vol(5, UL),
      vol(1, UL), vol(1, UL), vol(0.25, UL), vol(24.75, UL)
    };
    mixing_table_pcr(
