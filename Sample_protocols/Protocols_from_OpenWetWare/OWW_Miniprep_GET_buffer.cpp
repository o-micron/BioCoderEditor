...
main()
{
  ...
  next_step();
  centrifuge_pellet(
    sterile_microfuge_tube, speed(SPEED_MAX, RPM), RT, time(1, MINS));

  // 3. Add 100ul of refrigerated GET buffer to the pellet and vortex to
  // resuspend.
  next_step();
  ...
  // After step 3 add 10mg lysozyme and incubate for 30 mins before proceeding
  // with step 4. This step is essential for lysing gram-positive cells.
  optional_step();
  ...
  // 5. Apply the alkaline SDS solution to the cell suspension and invert to
  // mix. DO NOT VORTEX! The solution should become clear.
  next_step();
  ...
  // 6. Add 150ul of refrigerated potassium acetate solution and invert gently
  // to mix. DO NOT VORTEX! A precipitate should form.
  next_step();
  ...
  // 9. Carefully pipet 400ul of the clean supernatant into a new tube. DO NOT
  // PICK UP ANY PRECIPITATE!!!
  next_step();
  centrifuge_phases_top(sterile_microfuge_tube,
                        speed(SPEED_MAX, RPM),
                        RT,
                        time(10, MINS),
                        vol(400, UL),
                        sterile_microfuge_tube2);
  comment("DO NOT PICK UP ANY PRECIPITATE!!!");

  // After step 9 add 400�l PCA solution to the tube, invert to mix, and
  // centrifuge for 3 minutes at maximum speed. Collect the upper phase by
  // pipetting into a new tube and proceed with step 10. This step helps remove
  // any residual proteins.
  optional_step();
  ...
  // 12. Centrifuge the precipitated plasmid DNA 10 minutes at maximum speed and
  // discard supernatant.
  next_step();
  centrifuge_pellet(
    sterile_microfuge_tube2, speed(SPEED_MAX, RPM), RT, time(10, MINS));
  ...
  // 14. Centrifuge at maximum speed for 3 minutes. Make sure the pellet is
  // toward the outside.
  next_step();
  centrifuge_pellet(
    sterile_microfuge_tube2, speed(SPEED_MAX, RPM), RT, time(3, MINS));
  ...
  // 16. Once the pellet is COMPLETELY DRY resuspend the plasmid DNA in 20 ul of
  // TE or distilled water. The DNA will contain RNA contamination, which can be
  ...
  comment(" The DNA will contain RNA contamination, which can be removed by "
          "resuspending in TE with RNAse.");
