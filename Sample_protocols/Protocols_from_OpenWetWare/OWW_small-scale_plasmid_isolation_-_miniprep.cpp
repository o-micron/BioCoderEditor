...
main()
{
  ...
  Fluid rnase =
    new_fluid("RNase to a final concentration of 3�g/ml", vol(2, UL));
  ...
  //   1. Take the overnight culture and spin down 1.5mL (50mL) of cells for 3
  //   (5) minutes.
  first_sub_step();
  ...
  //   3. Re-suspend the pellet in 100�L (1mL) of ice cold Solution I.
  next_sub_step();
  measure_fluid(sol1, vol(1, ML), tube1);
  resuspend(tube1);

  //   4. Add 200�L (2mL) of Solution II and gently invert the tube (roll the
  //   falcon) to mix. Leave on ice for 5 minutes.
  next_sub_step();
  measure_fluid(sol2, vol(200, UL), tube1);
  invert(tube1);
  store_for(tube1, ON_ICE, time(5, MINS));

  //   5. Add 150�L (1.5mL) of Solution III and shake vigorously. Leave on ice
  //   for 10 minutes.
  next_sub_step();
  ...
  //   2. Add 0.5 volumes of phenol and 0.5 volumes of chloroform to 1 volume of
  //   supernatant ~250:250->500�L (2.5:2.5->5mL).
  first_sub_step();
  ...
  // RNase (optional):
  optional_step("RNase");
  //   1. Add RNase to a final concentration of 3�g/mL (5�L of 3mg/mL diluted
  //   stock / 5�L of 30mg/mL stock).
  first_sub_step();
  ...
  //   5. Wash the pellet with 200�L (2mL) of 70% ethanol by pipetting.
  next_sub_step();
  ...
  //   7. Remove all the alcohol by pipetting and air dry the pellet for up to
  //   30 minutes.
  next_sub_step();
  dry_pellet(tube4, IN_AIR, max_time(30, MINS));

  //   8. Re-suspend the DNA pellet in 30-50�L (200-300�L) sdH2O.
  next_sub_step();
