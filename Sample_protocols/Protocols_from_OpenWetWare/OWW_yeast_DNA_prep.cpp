...
main()
{
  ...
  Fluid yeast_cul = new_fluid("yeast culture grown up to appropriate density",
                              "near saturation");
  Fluid break_buffer =
    new_fluid("breaking buffer",
              "2% (v/v) Triton X-100, 1% (w/v) SDS, 100 mM NaCl, 10 mM "
              "Tris-Cl, pH 8.0, 1 mM EDTA, pH 8.0");
  Fluid phe_chloro_iaa =
    new_fluid("phenol : chloroform : isoamyl alcohol", "25:24:1", ICE_COLD);
  ...
  // 2. spin 1.5 mls of culture for 1 min in microfuge and aspirate off
  // supernatant
  first_step();
  ...
  comment("You can now use 1-2 ul of this crude yeast plasmid DNA prep to "
          "transform E. coli.");
